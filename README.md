...
1. Connect the  3-phase wires (**thick**) from the motor to the **connector J14**,  provided on the Motor Control Development Board in the specified order (as shown in Table 1).
     <p align="left" >
